      ...
      <div className="mx-auto max-w-5xl space-y-8">
        <section className="rounded-lg border border-zinc-200 p-5 dark:border-zinc-800">
          ...
          <p className="mt-3 text-xs text-zinc-500">
            家系図キャンバス(react-flow)は Phase 5 で追加されます。現在はリスト UI です。
          </p>
        </section>
      ...
      <Modal open={!!editingRelation} onClose={() => setEditingRelation(null)} title="関係を編集">
        {editingRelation && (
          <RelationForm
            ...
            onSubmit={async (input) => {
              // Reuse create path for "edit" since spouse normalization may swap ids;
              // delete + create keeps invariants simple in v1.
